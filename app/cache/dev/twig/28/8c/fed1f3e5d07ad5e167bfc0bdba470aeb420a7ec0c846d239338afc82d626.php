...
<ul>
 ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "lesErreurs"));
        foreach ($context['_seq'] as $context["_key"] => $context["erreur"]) {
            // line 4
            echo "\t
      <li>";
            // line 5
            echo twig_escape_filter($this->env, $this->getContext($context, "erreur"), "html", null, true);
            echo "</li>
\t
";
        }
...
";
    ...
    {
        return array (  30 => 5,  27 => 4,  23 => 3,  19 => 1,  50 => 7,  46 => 6,  42 => 5,  39 => 8,  32 => 3,  29 => 2,);
    }
}
